...
driver.find_element_by_id('com.izp.f2c:id/top_tv_left').click()
time.sleep(10)
positions = []
positions.append((174, 182))
positions.append((264, 172))
driver.tap(positions)
driver.find_element_by_id('com.izp.f2c:id/product_list_tv_name').click()
driver.find_element_by_id('com.izp.f2c:id/product_detail_bt_buy').click()
driver.find_element_by_id('com.izp.f2c:id/order_submitbtn').click()
driver.reset()
